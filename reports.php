                ...
                <div class="row g-2 justify-content-between mb-1">
                    ...
                    <div class="row text-center">
                        ...
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                                    <svg width="20" height="20" fill="white" class="bi bi-calendar2-date" viewB="0 0 16 16">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ចំណូលប្រចាំថ្ងៃ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 mr-2 p-2">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ទំនិញលក់ប្រចាំថ្ងៃ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 mr-2 p-2">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ទិញទំនិញប្រចាំថ្ងៃ</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 mt-2"><h5><strong>ទិន្នន័យប្រចាំសប្តាហ៍</strong></h5></div> 
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                                    <svg width="20" height="20" fill="white" class="bi bi-calendar2-day" viewB="0 0 16 16">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ចំណូលប្រចាំសប្តាហ៍</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 mr-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍លក់ទំនិញប្រចាំសប្តាហ៍</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 mr-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ទិញទំនិញប្រចាំសប្តាហ៍</a>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 mt-2"><h5><strong>ទិន្នន័យប្រចាំខែ</strong></h5></div> 
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                                    <svg width="20" height="20" fill="white" class="bi bi-calendar2-month" viewB="0 0 16 16">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ចំណូលប្រចាំខែ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 mr-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍លក់ទំនិញប្រចាំខែ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 mr-2 p-2">
                            <div class="text-center">
                                    <a href="#">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ទិញទំនិញប្រចាំខែ</a>
                        </div>
                    </div>
                    ...
                    <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 p-2">
                            ...
                            <a style="text-decoration: none; color:white;" href="#">របាយការណ៍ចំណូលសរុប</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 p-2">
                            <div class="text-center">
                            ...
                            <a style="text-decoration: none; color:white;" href="sale_report.php">របាយការណ៍លក់ទំនិញ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 mr-2 p-2">
                            <div class="text-center">
                            ...
                            <a style="text-decoration: none; color:white;" href="purchase_report.php">របាយការណ៍ទិញទំនិញ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 mr-2 p-2">
                            <div class="text-center">
                            ...
                            <a style="text-decoration: none; color:white;" href="salary_report.php">របាយការណ៍ប្រាក់ខែ</a>
                        </div>
                    </div>
