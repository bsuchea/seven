    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        ...
        <div class="container-xl">
            <div class="position-relative mb-3">
                <div class="row g-2 justify-content-between mb-1">
                    <div class="col-auto">
                        <h1 style="font-family: 'Kantumruy Pro ExtraLight'; color:#15a362; font-size:large"
                            class="app-page-title mb-3">ទំព័រព័ត៌មានចំណូលប្រចាំសប្តាហ៍</h1>
                            <div class="mb-2">
                ...
                <div style="height: 30%; width: 30%" class="container mb-2 bg-light shadow-sm rounded-4 border border-success mr-1">
                                <h6 class="mt-1">ចំណូលដែលរកបានក្នុងសប្តាហ៍នេះគឺ : <span id="total"></span>$</h6>
                            </div>
