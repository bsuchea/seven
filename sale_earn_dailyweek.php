            ...
            <div class="container-xl">
                <div class="position-relative mb-3">
                    <div class="row g-2 justify-content-between mb-1">
                        <div class="col-auto">
                            <h1 style="font-family: 'Kantumruy Pro ExtraLight'; color:#15a362; font-size:large" class="app-page-title mb-3">ទំព័រព័ត៌មានចំណូលប្រចាំសប្តាហ៍</h1>
                            <div class="mb-2">
                    ...
                    <div style="display:flex; justify-content: right;">
                        <div style="padding: 5px 10px; font-weight: bold; font-family: 'Kantumruy Pro ExtraLight';" class="mb-2 bg-light shadow-sm rounded-4 border border-success mr-1">
                            ចំណូលដែលរកបានក្នុងសប្តាហ៍នេះគឺ : <span id="total"></span>$<?= $totalAmount ?>
                        </div>
                    </div>
