                    ...
                    <div class="container bg-white p-3 mt-3 shadow p-3 mb-5 bg-body rounded-4">
                        ...
                        <div class="row  text-center">
                            <div class="col-md-6 mb-3 mt-3">
                                ...
                                <input type="text" value="<?= $data->brand_name ?>" name="brand_name" class="form-control" placeholder="Brand Name">
                            </div>
                            <div class="col-md-6 mb-3 mt-3">
                                <label class="form-label">Description or Notes</label>
                                <textarea value="<?= $data->description ?>" name="description" class="form-control" rows="10" cols="10"></textarea>
                            </div>
                        </div>
