<?php include_once('config/db.php');?>	    
								...
								<tbody>
                                    <tr>
										...
										<button style="width: 30px; height:30px;" id="print" type="button" class="btn btn-info rounded-circle btn-just-icon btn-sm" data-original-title="" title="Print">
