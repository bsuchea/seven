            ...
            <div class="position-relative mb-3">
                <div class="row g-2 justify-content-between mb-1">
                    ...
                    <div class="row text-center">
                        ...
                        <div>
                                    <a href="brand.php">
                                    <svg width="20" height="20" fill="white" class="bi bi-apple" viewB="0 0 16 16">
                            ...
                            <a style="text-decoration: none; color:white;" href="brand.php">ប្រេនទំនិញ</a>
                        </div>
                        <div style="background-color:#15a362 ;" class="col border rounded-5 ml-2 mr-2 p-2">
                        <div>       
                                    <a href="category.php">
                                    <svg width="20" height="20" fill="white" class="bi bi-tags" viewB="0 0 16 16">
                                    <path d="M3 2v4.586l7 7L14.586 9l-7-7H3zM2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2z"/>
                                    <path d="M5.5 5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1v5.086z"/>
                                    </svg>
                                    </a>
                        </div>
                            <a style="text-decoration: none; color:white;" href="category.php">ប្រភេទទំនិញ</a>
                        </div>
                    </div>
                    </div>
                </div>
