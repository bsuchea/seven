                ...
                <div class="row g-2 justify-content-between mb-1">
                    <div class="col-auto">
                        <h1 style="font-family: 'Kantumruy Pro ExtraLight'; color:#15a362; font-size:large"
                            ...
                            <button class="btn btn-sm btn-success rounded-5">
                            <a style="color: white; text-decoration: none;" href="brand_create.php" title="Add New">
                    ...
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel"
                        ...
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                            <div class="app-card-body">
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        while ($row = $sql_select->fetch(PDO::FETCH_OBJ)) :
                                            $i++;
                                            ?>
                                            <tr id="brand<?= $row->brand_id ?>">
                                                <td class="text-center"><?= $i ?></td>
                                                <td><?= $row->brand_name ?></td>
                                                <td><?= $row->description ?></td>
                                                <td class="td-actions text-center">
                                                    <a href="brand_edit.php?id=<?= $row->brand_id ?>" class="p-2">
                                                    ...
                                                    <a href="#" class="text-danger" onclick="delBrand(<?= $row->brand_id ?>)" class="p-2">
                                                        <svg width="20" height="20" fill="currentColor"
                                ...
                                <?php
                                $query = $con->query("SELECT * FROM tbl_brand");
                                ...
                                <nav class="app-pagination mt-4">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <?= $page == 1 ? 'disabled' : '' ?> ">
                                            <a class="page-link" href="brand.php?page=<?= $page - 1 ?>"
                                               tabindex="-1"
                                               aria-disabled="true">Previous</a>
                                        </li>
                                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                            <li class="page-item active"><a class="page-link"
                                                                            href="brand.php?page=<?= $i ?>"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <li class="page-item <?= $page == $total_pages ? 'disabled' : '' ?> ">
                                            <a class="page-link" href="brand.php?page=<?= $page + 1 ?>">Next</a>
                                        </li>
                                    </ul>
                                </nav><!--//app-pagination-->
                                <br>
...
<script type="text/javascript">
    function delBrand(id){
        swal.fire({
            title: "Are you sure?",
            text: "Do you really want to remove this Brand?",
            icon: "warning",
            showDenyButton: true,
