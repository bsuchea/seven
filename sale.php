...
<div class="app-wrapper">
    <div class="app-content pt-3 p-md-3 p-lg-4">
        ...
        if (isset($_POST['add_sale'])) {
            ...
            if (empty($buyer_name) || ($buyer_phone) || empty($item_name) ||  empty($sale_qty) || empty($sale_date)) {
                echo '
                    ...
                    <div class="container bg-white p-3 mt-3 shadow p-3 mb-5 bg-body rounded-4">
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" name="buyer_phone" class="form-control" placeholder="Buyer Phone">
                                </div>
                                <div class="form-group col-md-4">
